          ...
          <div className="aspect-[9/16] md:aspect-video bg-black rounded-xl overflow-hidden relative shadow-2xl">
              {isLoading ? (
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-zinc-900 text-white p-8 py-12 md:p-6 text-center">
                  <Video className="w-12 h-12 md:w-16 md:h-16 mb-4 md:mb-6 text-primary opacity-80" data-testid="icon-video" />
                  ...
                  <div className="flex flex-col gap-3 mt-6 md:mt-8">
                    <Link href="/live">
                      <Button 
                        size="lg" 
                        className="w-full bg-[#b47a5f] hover:bg-[#a06b52] text-white font-bold px-6 md:px-8"
                    ...
                    {zoomLink && (
                      <a href={zoomLink} target="_blank" rel="noopener noreferrer">
                        <Button 
                          size="lg" 
                          className="w-full bg-[#2563eb] hover:bg-[#1d4ed8] text-white font-bold px-6 md:px-8"
